...
public class TabWithImages2 extends AppCompatActivity implements OneFragment.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_with_images2);
